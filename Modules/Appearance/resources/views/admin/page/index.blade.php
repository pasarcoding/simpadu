...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                @can(\App\Constants\PermissionName::appearance_page_create())
                    <div class="card-header d-flex justify-content-end">
                        <a href="{{ route('admin.appearance.page.create') }}" class="btn btn-sm btn-primary">Tambah Data <i
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus data halaman ini? Aksi ini tidak dapat dibatalkan.
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('.datatable').DataTable({
                ...
                responsive: true,
                scrollX: true,
                ajax: "{{ route('admin.appearance.page.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
