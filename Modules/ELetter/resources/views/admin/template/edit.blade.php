...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item" aria-current="page">Edit Template Surat</li>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.e-letter.template.update', $data->id) }}" method="POST"
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                    placeholder="Masukkan Nama Surat" value="{{ old('name', $data->name) }}" required>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="last_sequence_number" id="last_sequence_number"
                                    ...
                                    value="{{ old('last_sequence_number', str_pad($data->last_sequence_number, $data->padding_sequence_length, '0', STR_PAD_LEFT)) }}"
                                    required>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                <label for="file" class="form-label">File Template (docx) (<a href="{{ $data->file }}"
