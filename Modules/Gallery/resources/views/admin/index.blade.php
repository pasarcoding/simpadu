...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                @can(\App\Constants\PermissionName::gallery_create())
                    <div class="card-header d-flex justify-content-end">
                        <a href="{{ route('admin.gallery.create') }}" class="btn btn-sm btn-primary">Tambah Data
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus data galeri ini? Aksi ini tidak dapat dibatalkan.
                </div>
