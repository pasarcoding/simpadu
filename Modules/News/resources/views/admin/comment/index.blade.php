...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item" aria-current="page">Komentar Berita</li>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <span class="fw-bold">Komentar Berita <i>"{{ $data->title }}"</i></span>
                </div>
                <div class="card-body">
                    @if (session('error'))
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus data komentar ini? Aksi ini tidak dapat dibatalkan.
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('.datatable').DataTable({
                ...
                responsive: true,
                scrollX: true,
                ajax: "{{ route('admin.news.comment.index', ':id') }}".replaceAll(':id',
                    '{{ $data->id }}'),
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
