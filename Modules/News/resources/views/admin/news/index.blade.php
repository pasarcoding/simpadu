...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                @can(\App\Constants\PermissionName::news_create())
                    <div class="card-header d-flex justify-content-end">
                        <a href="{{ route('admin.news.create') }}" class="btn btn-sm btn-primary">Tambah Data <i
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus data berita ini? Aksi ini tidak dapat dibatalkan.
                </div>
