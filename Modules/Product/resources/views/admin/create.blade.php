...
@section('content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data" class="card">
                @csrf
                <div class="card-body">
                    @if (session('error'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="tel" name="whatsapp_number" id="whatsapp_number" pattern="^(\+62|0)8[0-9]{8,12}$" class="form-control"
                                    placeholder="Masukkan No. Whatsapp" value="{{ old('whatsapp_number') }}" required>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label for="description" class="form-label">Deskripsi <span class="text-danger">*</span></label>
                                <textarea name="description" id="description" class="form-control" placeholder="Masukkan Deskripsi" required>{{ old('description', getDescriptionTemplate()) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
