...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                @can(\App\Constants\PermissionName::product_create())
                    <div class="card-header d-flex justify-content-end">
                        <a href="{{ route('admin.product.create') }}" class="btn btn-sm btn-primary">Tambah Data <i
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus data produk ini? Aksi ini tidak dapat dibatalkan.
                </div>
