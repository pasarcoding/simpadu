...
@section('content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.resident.update', $data->id) }}" method="POST" enctype="multipart/form-data"
                class="card">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="full_name" id="full_name" class="form-control"
                                    placeholder="Masukkan Nama Lengkap" value="{{ old('full_name', $data->full_name) }}"
                                    required>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="gender" id="gender" class="form-control select2" required>
                                    ...
                                    @foreach (getGenderList() as $k => $v)
                                        <option value="{{ $k }}"
                                            {{ old('gender', $data->gender) == $k ? 'selected' : '' }}>
                                            {{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="birth_place" id="birth_place" class="form-control"
                                    placeholder="Masukkan Tempat Lahir"value="{{ old('birth_place', $data->birth_place) }}"
                                    required>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="citizenship" id="citizenship" class="form-control select2" required>
                                    ...
                                    @foreach (getCitizenshipList() as $k => $v)
                                        <option value="{{ $k }}"
                                            {{ old('citizenship', $data->citizenship) == $k ? 'selected' : '' }}>
                                            {{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        {{-- <div class="col-12 col-lg-6">
                            <div class="form-group">
                                <label for="image" class="form-label">Foto (<a href="{{ $data->image }}" target="_blank">Lihat <i
                            ...
                            <div class="form-group">
                                ...
                                <select name="religion" id="religion" class="form-control select2" required>
                                    ...
                                    @foreach (getReligionList() as $k => $v)
                                        <option value="{{ $k }}"
                                            {{ old('religion', $data->religion) == $k ? 'selected' : '' }}>
                                            {{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="other_job" id="other_job" class="form-control"
                                    value="{{ old('other_job', $data->other_job) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="last_education" id="last_education" class="form-control select2" required>
                                    ...
                                    @foreach (getEducationList() as $k => $v)
                                        <option value="{{ $k }}"
                                            {{ old('last_education', $data->last_education) == $k ? 'selected' : '' }}>
                                            {{ $v }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="marital_status" id="marital_status" class="form-control select2" required>
                                    ...
                                    @foreach (getMaritalStatusList() as $k => $v)
                                        <option value="{{ $k }}"
                                            {{ old('marital_status', $data->marital_status) == $k ? 'selected' : '' }}>
                                            {{ $v }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="family_relationship" id="family_relationship" class="form-control select2"
                                    ...
                                    @foreach (getFamilyRelationshipList() as $k => $v)
                                        <option value="{{ $k }}"
                                            {{ old('family_relationship', $data->family_relationship) == $k ? 'selected' : '' }}>
                                            {{ $v }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="family_card_number" id="family_card_number"
                                    ...
                                    value="{{ old('family_card_number', $data->family_card_number) }}" required>
                            </div>
                        </div>
                    </div>
                    <hr>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="address" class="form-label">Alamat Lengkap <span
                                        class="text-danger">*</span></label>
                                <textarea name="address" id="address" class="form-control" placeholder="Masukkan Alamat Lengkap" required>{{ old('address', $data->address) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="rt" id="rt" class="form-control"
                                    placeholder="RT" value="{{ old('rt', $data->rt) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="rw" id="rw" class="form-control"
                                    placeholder="RW" value="{{ old('rw', $data->rw) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="hamlet_village" id="hamlet_village" class="form-control"
                                    ...
                                    value="{{ old('hamlet_village', $data->hamlet_village) }}">
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="death_status" id="death_status" class="form-control select2" required>
                                    ...
                                    @foreach (getDeathStatusList() as $k => $v)
                                        <option value="{{ $k }}"
                                            {{ old('death_status', $data->death_status) == $k ? 'selected' : '' }}>
                                            {{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="resident_forms[{{ $item->id }}]"
                                                ...
                                                value="{{ old('resident_forms.' . $item->id, $formValue->get($item->id)->value ?? '') }}">
                                        </div>
                                    </div>
                                @else
                                    <div class="col-12 col-lg-6">
