                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4 border-bottom pb-3">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <p class="mb-0">
                                {{ $data->job == 'lainnya' ? $data->other_job : getJobList()[$data->job] ?? 'N/A' }}</p>
                        </div>
                    ...
                    @if ($data->resident_form_value)
                        <h5 class="mb-3 text-primary"><i class="ti ti-map-pin me-1"></i> Data Tambahan</h5>
                        <div class="row">
                            @foreach ($data->resident_form_value as $item)
                                <div class="col-12 col-md-12 col-lg-4 mb-3">
                                    <strong class="text-muted d-block">{{ $item->resident_form->name }}</strong>
