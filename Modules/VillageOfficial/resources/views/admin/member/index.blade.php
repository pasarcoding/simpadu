...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                @can(\App\Constants\PermissionName::village_official_member_create())
                    <div class="card-header d-flex justify-content-end">
                        <a href="{{ route('admin.village-official.member.create') }}" class="btn btn-sm btn-primary">Tambah Data
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus data anggota ini? Aksi ini tidak dapat dibatalkan.
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('.datatable').DataTable({
                ...
                responsive: true,
                scrollX: true,
                ajax: "{{ route('admin.village-official.member.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
